...
-   [CVE-2019-18276](https://ubuntu.com/security/notices/USN-5380-1)
      ...
      - released images to mitigate latest versions of cyrus sasl, gnu c, Openssl, Tar, Zlib, Fribidi, Git, Nginx lua , Gzip, Xz utils and Bash  Vulnerabilities.
...
-   [CVE-2022-25310](https://ubuntu.com/security/notices/USN-5366-1)
     ...
     - released images to mitigate latest versions of tar and openssl,zlib,gnu,cyrus,fribidi Vulnerabilities. 
...
-   [CVE-2018-16869](https://usn.ubuntu.com/4990-1)
-   [CVE-2021-3580](https://usn.ubuntu.com/4990-1)

 -   **Dependencies** : 
  
     -   added libssl1.1 and libnettle6 package in dockerfile to mitigate vulnerabilities.
