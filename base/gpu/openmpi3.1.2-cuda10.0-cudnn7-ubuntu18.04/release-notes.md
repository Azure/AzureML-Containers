...
-   [CVE-2022-25310](https://ubuntu.com/security/notices/USN-5366-1) need to change
 
     - released images to mitigate latest versions of Zlib, Git, Gzip, Xz utils and Bash Vulnerabilities. 
